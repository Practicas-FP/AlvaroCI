...
import 'package:flutter_rick_morty/features/presentation/bloc/search_bloc/search_bloc.dart';
import 'package:flutter_rick_morty/widgets/search_error_message.dart';
import 'package:flutter_rick_morty/widgets/search_result.dart';
      ...
      builder: (context, state) {
        if (state is SearchLoading) {
          ...
          if (character.isEmpty) {
            return const SearchErrorMessage(errorMessage: 'No characters found :(');
          }
